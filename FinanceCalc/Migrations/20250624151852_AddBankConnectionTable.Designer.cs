...
namespace FinanceCalc.Migrations
{
    ...
    [Migration("20250624151852_AddBankConnectionTable")]
    partial class AddBankConnectionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceCalc.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FinanceCalc.Models.BankConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinanceCalc.Models.BankConnection", b =>
                {
                    b.HasOne("FinanceCalc.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinanceCalc.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
